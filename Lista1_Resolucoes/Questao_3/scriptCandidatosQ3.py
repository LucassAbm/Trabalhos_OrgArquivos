...
class random_stuff():
    def __init__(self):
        ...
        #cpf vars
        self.cpf_list = [random.randrange(10000000000, 99999999999) for i in range(50)]
...
f = open('./candidatosA.dat', 'wb')
g = open('./candidatosB.dat', 'wb')
...
for i in range(0,50):
    if i % 2 != 0:
        ...
        if i % 5 == 0:
            g.write(candidatoStruct.pack(*candidate))
