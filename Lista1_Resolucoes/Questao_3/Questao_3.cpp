...
int main() {
    ...
    //Abrindo os arquivos
    candidatosA = fopen("C:\Users\labma\Desktop\Org. e Estrutura de Arquivos\Lista1_Resolucoes\Questao_3.exe\candidatosA.dat", "rb");
    candidatosB = fopen("C:\Users\labma\Desktop\Org. e Estrutura de Arquivos\Lista1_Resolucoes\Questao_3.exe\candidatosB.dat", "rb");
